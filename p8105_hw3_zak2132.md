...
We see here a couple of outliers, on days 24 and 31, that are 2.34
standard deviations below the mean. Interestingly, the
...
activity on Friday evenings and on Sunday around the middle of the day,
as well as an unusually low amount of activity every day of the week
until several hours into the morning.

I would prefer to group by day of week first and then find the mean at a
given minute during the day, and plot that over time, like so:
